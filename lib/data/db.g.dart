...
class $$CategoryBudgetsTableFilterComposer
    extends Composer<_$PaisaDatabase, $CategoryBudgetsTable> {
...
typedef $$CategoryBudgetsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (
        CategoryBudget,
        BaseReferences<_$PaisaDatabase, $CategoryBudgetsTable, CategoryBudget>,
      ),
      CategoryBudget,
      PrefetchHooks Function()
    >;
...
class $$SavingsGoalsTableFilterComposer
    extends Composer<_$PaisaDatabase, $SavingsGoalsTable> {
...
class $$SavingsGoalsTableTableManager
    extends
        RootTableManager<
          ...
          (
            SavingsGoal,
            BaseReferences<_$PaisaDatabase, $SavingsGoalsTable, SavingsGoal>,
          ),
          SavingsGoal,
          PrefetchHooks Function()
        > {
  $$SavingsGoalsTableTableManager(_$PaisaDatabase db, $SavingsGoalsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
