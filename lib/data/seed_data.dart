...
class SeedData {
  ...
  static Future<void> _seedTransactions(SpendlerDatabase db) async {
    ...
    final txns = <SpendlerTransactionsCompanion>[
      ...
      _t(2026, 3, 30, 13, 0, -222, 'foodAndDrink', 'Swiggy', 'Leons Paneer Biryani'),

      // ── March 31 ──
      _t(2026, 3, 31, 9, 0, -86, 'transport', 'Uber', 'Auto'),
      _t(2026, 3, 31, 13, 0, -248, 'foodAndDrink', 'Zomato', 'Burrito Bowl Paneer'),
      ...
      _t(2026, 4, 3, 14, 0, -328, 'education', 'District', 'Project Hail Mary'),

      // ── April 4 ──
      _t(2026, 4, 4, 8, 0, -51.2, 'transport', 'Uber', 'Bike'),
      _t(2026, 4, 4, 8, 30, -34.8, 'transport', 'Uber', 'Bike'),
      _t(2026, 4, 4, 13, 0, -200, 'foodAndDrink', 'Zomato', 'Burrito'),
      _t(2026, 4, 4, 10, 0, -19136, 'shopping', 'Vasu', 'Rent'),
      _t(2026, 4, 4, 10, 30, -75, 'shopping', 'Aryan', 'Maid'),
      _t(2026, 4, 4, 18, 0, -43, 'transport', 'Uber', 'Bike'),
      _t(2026, 4, 4, 11, 0, -15634, 'shopping', 'Sai Dixit', 'Rent + electricity + Maid'),

      // ── April 5 ──
      _t(2026, 4, 5, 10, 0, -58000, 'shopping', 'Owner', 'Rent'),
      _t(2026, 4, 5, 10, 30, -6461, 'shopping', 'Maintenance', 'Rent'),
      _t(2026, 4, 5, 11, 0, -5284, 'shopping', 'Electricity', 'House'),
      _t(2026, 4, 5, 13, 0, -314, 'foodAndDrink', 'Zomato', 'Lunch (7 Sisters)'),
      _t(2026, 4, 5, 20, 0, -155, 'foodAndDrink', 'Punch Kattu', 'Dinner'),

      // ── April 6 ──
      _t(2026, 4, 6, 11, 0, -267, 'personalCare', 'Zepto', 'Washing soap and Harpic'),
      _t(2026, 4, 6, 10, 0, -3500, 'shopping', 'Maid', 'Salary'),
      ...
      _t(2026, 4, 7, 11, 0, -165, 'foodAndDrink', 'Grocery', 'Torai, Curd'),
      _t(2026, 4, 7, 15, 0, -50, 'foodAndDrink', 'Amul Ice Cream', 'Ice cream'),

      // ── April 8 ──
      _t(2026, 4, 8, 9, 0, -73, 'transport', 'Uber', 'Bike'),
      _t(2026, 4, 8, 13, 0, -256, 'foodAndDrink', 'Swiggy', 'Burrito'),

      // ── April 9 ──
      _t(2026, 4, 9, 9, 0, -67, 'transport', 'Uber', 'Bike'),
      _t(2026, 4, 9, 10, 0, -3500, 'personalCare', 'Ram', 'Sent back'),
      ...
      _t(2026, 4, 11, 13, 0, -252, 'foodAndDrink', 'Zomato', 'Lunch'),
      _t(2026, 4, 11, 18, 0, -138, 'transport', 'Uber', 'Auto'),
      _t(2026, 4, 11, 18, 30, -48, 'transport', 'Uber', 'Bike'),

      // ── April 12 ──
      _t(2026, 4, 12, 20, 0, -195, 'foodAndDrink', 'Zomato', 'Dinner'),
      _t(2026, 4, 12, 21, 0, -302, 'foodAndDrink', 'Swiggy', 'Food'),

      // ── April 13 ──
      _t(2026, 4, 13, 9, 0, -77, 'transport', 'Uber', 'Bike'),
      _t(2026, 4, 13, 18, 0, -45, 'transport', 'Uber', 'Bike'),
      _t(2026, 4, 13, 22, 0, -130, 'shopping', 'Unknown', 'Not sure 10 pm'),

      // ── April 14 ──
      _t(2026, 4, 14, 10, 0, -355, 'productivityTools', 'Jio', 'Mobile Recharge'),
      _t(2026, 4, 14, 9, 0, -100, 'transport', 'Uber', 'Auto'),
      _t(2026, 4, 14, 18, 0, -46.44, 'transport', 'Uber', 'Bike'),
      _t(2026, 4, 14, 15, 0, -447, 'foodAndDrink', 'Blinkit', null),

      // ── April 15 ──
      _t(2026, 4, 15, 9, 0, -121, 'transport', 'Uber', 'Auto'),
      _t(2026, 4, 15, 14, 0, -236, 'shopping', 'Delhivery', 'Headphone Parcel'),
      _t(2026, 4, 15, 13, 0, -354, 'foodAndDrink', 'Zomato', "Ram's Food"),
      ...
      // ── April 19 ──
      _t(2026, 4, 19, 9, 0, -286, 'foodAndDrink', 'Swiggy Insta', 'Sunday Morning (Juice)'),
      _t(2026, 4, 19, 10, 0, -30, 'personalCare', 'Toothbrush', 'Vasu'),
      _t(2026, 4, 19, 13, 0, -254, 'foodAndDrink', 'Swiggy', 'Lunch'),
      _t(2026, 4, 19, 20, 0, -419, 'foodAndDrink', 'Dominos', 'Dinner'),

      // ── April 20 ──
      _t(2026, 4, 20, 13, 0, -242.28, 'foodAndDrink', 'Zomato', 'Lunch'),
      _t(2026, 4, 20, 7, 0, -1800, 'gymFitness', 'NMDC Marathon', 'Running 10K'),

      // ── April 21 ──
      _t(2026, 4, 21, 9, 0, -51.8, 'transport', 'Uber', 'Bike'),
      _t(2026, 4, 21, 18, 0, -43, 'transport', 'Uber', 'Bike'),
      _t(2026, 4, 21, 11, 0, -155, 'foodAndDrink', 'Grocery', 'Aloo + Banana + Curd'),
    ];
