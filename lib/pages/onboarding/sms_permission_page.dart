      ...
      builder: (_) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Samsung path: Settings → Apps → Spendler → Permissions → SMS → Allow
            ...
            Container(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4),
                  Text('2. Apps → Spendler → Permissions', style: TextStyle(color: SpendlerColors.textPrimary, fontSize: 14)),
                  SizedBox(height: 4),
