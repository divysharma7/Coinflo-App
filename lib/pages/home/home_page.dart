...
// ─── Section A: Greeting + Today's Summary ─────────────
...
// ─── Section B: Current Balance Hero Card ──────────
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                const Text('CURRENT BALANCE', style: SpendlerTextStyles.sectionLabel),
                Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    GestureDetector(
            ...
            // Hero amount — white text on black
            weeklyTxns.when(
              data: (txns) {
                final spent = txns
                    .where((t) => t.amount < 0)
